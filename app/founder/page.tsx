                  ...
                  >
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute inset-0 p-6 flex flex-col justify-between opacity-0 group-hover:opacity-100 transition-all duration-500">
                        <h2 className="text-2xl font-lexend-bold text-white transform translate-x-[-20px] opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100">{item.title}</h2>
                        <p className="text-gray-400 text-right self-end transform translate-x-[20px] opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100">{item.description}</p>
                      </div>
                    </div>
                  </MagicCard>
                </a>
