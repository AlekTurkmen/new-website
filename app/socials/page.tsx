        ...
        <main className="max-w-4xl mx-auto py-16">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-4">
              <h1 className="text-5xl sm:text-6xl font-lexend-bold text-yellow-300 drop-shadow-[0_0_15px_rgba(253,224,71,0.9)] drop-shadow-[0_0_30px_rgba(253,224,71,0.6)]">
                SOCIALS
              </h1>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            ...
            >
              <svg className="w-16 h-16 text-[#ee7835]" viewBox="0 0 24 24" fill="currentColor">
